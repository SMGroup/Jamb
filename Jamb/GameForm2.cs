...
namespace Jamb
{
    public partial class GameForm2 : Form
    {
        ...
        public GameForm2(int pCount, StartForm form)
        {
            InitializeComponent();
            startForm = form;
        ...
        {
            int SumColl1P1 = 0, SumColl2P1 = 0, SumColl3P1 = 0, SumColl4P1 = 0, SumColl5P1 = 0, SumColl6P1 = 0, SumColl1P2 = 0, SumColl2P2 = 0, SumColl3P2 = 0, SumColl4P2 = 0, SumColl5P2 = 0, SumColl6P2 = 0;
            ...
            lblRezP1.Text = (SumColl1P1 + SumColl2P1 + SumColl3P1 + SumColl4P1 + SumColl5P1 + SumColl6P1).ToString();
            #endregion
            ...
            txtZbir_02_Min_Max_Odjava_P2.Text = (NotStr(txtMax_Odjava_P2.Text) + NotStr(txtMin_Odjava_P2.Text)).ToString();
            ...
            SumColl6P2 = (CalculateSumaColl(NotStr(txtZbir_01_Odjava_P2.Text), NotStr(txtZbir_02_Min_Max_Odjava_P2.Text), NotStr(txtZbir_03_Odjava_P2.Text)));

            lblRezP2.Text = (SumColl1P2 + SumColl2P2 + SumColl3P2 + SumColl4P2 + SumColl5P2 + SumColl6P2).ToString();
            #endregion
